...
### ステップ2：ラスタライズオプションを設定する（CADをPDFとして保存する）
...
### ステップ3：PDFオプションを設定する（CADからPDFを作成する）
...
### ステップ4：PDFとして保存する（3DモデルからPDFを生成する）
