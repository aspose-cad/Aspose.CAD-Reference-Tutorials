...
## Aspose.CAD for .NETを使用してOBJファイルをCADにインポートする方法
以下は簡潔で会話調の手順です。API 呼び出しはシンプルなので、コードブロックは不要です。

### ステップ1：Aspose.CAD NuGetパッケージを追加する
...
## 3Dモデルサポートチュートリアル
### [Aspose.CADでのOBJ形式のサポート - チュートリアル](./supporting-obj-format-in-aspose-cad/)
