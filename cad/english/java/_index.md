...
If you need to export a DWG as an image for quick sharing, follow the rasterization steps above and choose an appropriate image format. The resulting file can be used in documentation, emails, or web pages.
