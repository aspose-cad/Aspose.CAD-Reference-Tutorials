---
title: How to Set Background Color in Aspose.CAD for .NET – CAD Features and Support
...
// Load CAD file
using (var cadImage = (CadImage)Image.Load("sample.dwg"))
{
    ...
    var pdfOptions = new PdfOptions { VectorRasterizationOptions = options };
