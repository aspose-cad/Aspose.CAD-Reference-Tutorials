...
### Q2: 我可以为我的特定需求自定义光栅化选项吗？

A2: 可以，Aspose.CAD 在设置光栅化选项方面提供了灵活性，允许您根据需求定制输出。

### Q3: 在哪里可以找到 Aspose.CAD 相关查询的支持？

A3: 访问[Aspose.CAD 论坛](https://forum.aspose.com/c/cad/19)获取帮助并与社区互动。

### Q4: 是否有 Aspose.CAD for Java 的免费试用版？

A4: 有，您可以通过[此处](https://releases.aspose.com/)获取免费试用以探索 Aspose.CAD 的功能。
