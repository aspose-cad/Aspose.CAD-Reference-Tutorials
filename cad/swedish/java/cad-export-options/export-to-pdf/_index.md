...
description: Lär dig hur du ställer in PDF‑sidstorlek när du konverterar DWG till
  PDF med Aspose.CAD för Java, och upptäck PDF‑exportalternativ för att öka PDF‑upplösningen.
linktitle: Export to PDF
second_title: Aspose.CAD Java API
title: Ställ in PDF-sidstorlek – dwg till pdf java med Aspose.CAD
