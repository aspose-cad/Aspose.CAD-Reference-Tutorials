...
- **Apakah saya memerlukan lisensi untuk penggunaan produksi?** Lisensi komersial diperlukan; lisensi tersedia sementara untuk pengujian.
...
## Mengapa mengesampingkan deteksi halaman kode otomatis?
File DWG sering menyimpan teks menggunakan halaman kode warisan. Deteksi otomatis Aspose.CAD dapat salah menafsirkan byte‑byte ini, menghasilkan karakter yang kacau. Dengan menentukan kode halaman secara manual, Anda memastikan teks muncul tetap seperti yang dimaksud dalam PDF yang diekspor, terutama untuk skrip non‑Latin seperti Jepang, Cyrillic, atau Arab.
...
## Masalah & Solusi Umum
- **Karak sampah masih muncul:** Periksa kembali bahwa `specifiedEncoding` cocok dengan halaman kode DWG asli. Gunakan enum `CodePages` yang berbeda jika diperlukan.
...
J3: Versi percobaan diberlakukan batasan ukuran dan fitur; lihat dokumentasi resmi untuk detailnya.
